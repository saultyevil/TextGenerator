...
from text_generator import GenerationFailureError, TextGenerationInput, TextGenerator
from text_generator.prompts import read_in_system_prompt_yaml
...
class AIChatSummary(TextGenerator):
    ...
    SUMMARY_PROMPT = read_in_system_prompt_yaml("system_prompts/summarise.yaml").prompt
