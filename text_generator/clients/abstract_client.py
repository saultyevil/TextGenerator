...
class TextGenerationAbstractClient(metaclass=ABCMeta):
    ...
    def __init__(self, model_name: str, api_key: str, **kwargs: Any) -> None:
        ...
        **kwargs : Any
        ...
        self.token_size = self.count_tokens_for_message(self.system_prompt) if self.system_prompt else 0
        self._token_window_size = 4096
